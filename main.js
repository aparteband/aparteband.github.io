...
/* FIX 1.2 + 6.2: открытие ссылок по иконкам; если новая вкладка заблокирована — открыть в текущей */
document.addEventListener(__TAP_EVT, e => {
  const icon = e.target.closest ? e.target.closest(".icon") : null;
  if (!icon) return;
