...
/* MOBILE SCALE (2x): звёзды и их разнесение */
...
function createStars() {
  ...
  for (let i = 0; i < STAR_COUNT; i++) {
    ...
    star.className = "star";
       ...
       const size = rand(30, 80) * __STAR_MOBILE_SCALE;
    ...
    /* комфортное разнесение на мобиле: gap и keepOut тоже 2× */
    let gap = 20 * __STAR_MOBILE_SCALE;
    let heroR = heroRadius;
    let keepOut = FINAL_STAR_KEEP_OUT_PX * __STAR_MOBILE_SCALE;
    ...
    for (let tries = 0; tries < MAX_TRIES; tries++) {
      ...
      if (ok) break;
           ...
           if (tries === 220) gap = 12 * __STAR_MOBILE_SCALE;
      if (tries === 360) { gap = 6 * __STAR_MOBILE_SCALE; heroR *= 0.92; keepOut *= 0.92; }
