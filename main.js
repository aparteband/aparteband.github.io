...
function createStars() {
  ...
  for (let i = 0; i < STAR_COUNT; i++) {
    ...
    /* FIX: мобильная стабильность — используем единый __TAP_EVT */
  ...
  function onStart(e) {
    ...
    try {
      ...
      if (window.__primeAudioInOrder) {
        ...
        window.__primeAudioInOrder(batch3, exclude);
...
/* FIX: единый __TAP_EVT (чтобы на телефоне счётчик работал стабильно) */
document.addEventListener(__TAP_EVT, e => {
...
(function () {
  ...
  // sled.png: 512 x 512, contact point (polозья): (140,320)
