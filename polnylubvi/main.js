...
/* ============================================================
   ...
   - baseAmpPx:    амплитуда волны (волнистость)
...
const LINES_CFG = Object.freeze({
  ...
  yStepPx: 6,             // больше точек (гладче)
  topBottomOverscanPx: 80,

  avoidVideo: true,       // не рисовать в зоне видео
  avoidVideoPadPx: 14,    // отступ вправо от видео
  rightPadPx: 24          // отступ справа
});
...
function createLinesCanvas(stage) {
  ...
  function draw(tSec) {
    ...
    // если видео заняло почти всё — ничего не рисуем
